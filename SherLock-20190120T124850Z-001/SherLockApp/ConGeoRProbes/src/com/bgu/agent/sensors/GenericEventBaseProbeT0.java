...
@Probe.DisplayName("GenericEventBaseProbeT0")
@Schedule.DefaultSchedule(interval = 0, duration = 0, opportunistic = true)
public class GenericEventBaseProbeT0 extends SecureBase implements Probe.ContinuousProbe
{
    ...
    @Configurable
    private long maxWaitingTime = 60*60;
    ...
    protected void secureOnEnable()
    {
        ...
        if (sensors != null)
        {
            for (String sensor : sensors)
            {
                ...
                {
                    Logger.e(GenericEventBaseProbeT0.class, "Sensor " + sensor + " in generic event not found", e);
                }
            }
        }
        ...
        genericEventReceiver = new BroadcastReceiver()
        {
            ...
            public void onReceive(Context context, Intent intent)
            {
                synchronized (lock)
                {
                    ...
                    {
                        Logger.i(GenericEventBaseProbeT0.class, "Get new event");
                        ...
                        endOfTimeRunnable = new Runnable()
                        {
                            ...
                            public void run()
                            {
                                try
                                {
                                    synchronized (lock)
                                    {
                                        Logger.i(GenericEventBaseProbeT0.class, "Events waiting time over");
                    ...
                    {
                        Logger.i(GenericEventBaseProbeT0.class, "Get new event BUT in prosses");
    ...
    private void sendSensorsData()
    {
        ...
        if (eventsDic != null)
        {
            ...
            Logger.i(GenericEventBaseProbeT0.class, "Send data");
            ...
            try
            {
                ...
                {
                    Logger.e(GeneralSampleProbeT1.class, " Generic T0 - Null Data has been detected");
                }
        ...
        public void onDataReceived(IJsonObject probeConfig, IJsonObject data)
        {
            try
            {
                ...
                if (sensorsDataMapping != null && !sensorsDataMapping.contains(sensorName))
                {
                    ...
                    Logger.i(GenericEventBaseProbeT0.class, "Get new data from : " + sensorName);
