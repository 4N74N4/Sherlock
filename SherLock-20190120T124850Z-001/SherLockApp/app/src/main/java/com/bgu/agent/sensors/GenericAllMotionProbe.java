...
@Probe.DisplayName("GenericAllMotionProbe")
@Schedule.DefaultSchedule(interval = 0, duration = 0, opportunistic = true)
public class GenericAllMotionProbe extends SecureBase implements Probe.ContinuousProbe {
    ...
    protected void secureOnEnable()
    {
        ...
        if (sensors != null)
        {
            for (String sensor : sensors)
            {
                ...
                {
                    Logger.e(GenericAllMotionProbe.class, "Sensor " + sensor + " in generic event not found", e);
                }
            }
        }
        ...
        genericEventReceiver = new BroadcastReceiver()
        {
            ...
            public void onReceive(Context context, Intent intent)
            {
                synchronized (lock)
                {
                    ...
                    {
                        Logger.i(GenericAllMotionProbe.class, "Get new event");
                        ...
                        endOfTimeRunnable = new Runnable()
                        {
                            ...
                            public void run()
                            {
                                try
                                {
                                    synchronized (lock)
                                    {
                                        Logger.i(GenericAllMotionProbe.class, "Events waiting time over");
                    ...
                    {
                        Logger.i(GenericAllMotionProbe.class, "Get new event BUT in prosses");
    ...
    private void sendSensorsData()
    {
        ...
        if (eventsDic != null)
        {
            ...
            Logger.i(GenericAllMotionProbe.class, "Send data");
            ...
            try
            {
                ...
                {
                    Logger.e(GeneralSampleProbeT1.class, " Generic Motion - Null Data has been detected");
                }
        ...
        public void onDataReceived(IJsonObject probeConfig, IJsonObject data)
        {
            try
            {
                ...
                if (sensorsDataMapping != null && !sensorsDataMapping.contains(sensorName))
                {
                    ...
                    Logger.i(GenericAllMotionProbe.class, "Get new data from : " + sensorName);
