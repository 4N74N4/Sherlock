...
// comm1 @RequiredPermissions(android.Manifest.permission.READ_HISTORY_BOOKMARKS)
public class BrowserSearchesProbe extends DatedContentProviderProbe {

	@Override
	protected Uri getContentProviderUri() {
		return Uri.parse("content://browser/searches");
	}

	@Override
	protected String getDateColumnName() {
		//comm 2 return Browser.SearchColumns.DATE;
        return "abc";
	}
	...
	protected Map<String, CursorCell<?>> getProjectionMap() {
		...
		/* comm3 projectionKeyToType.put(Browser.SearchColumns._ID, intCell());
